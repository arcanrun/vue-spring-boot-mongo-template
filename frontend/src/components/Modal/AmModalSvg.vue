<template>
  <div>
    <div
      v-if="props.level === ModalLevel.ERROR"
    ...
    <div
      v-if="props.level === ModalLevel.INFO"
      class="mx-auto mb-5 flex h-10 w-10 items-center justify-center rounded-full bg-blue-100 text-blue-500"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
    ...
    <div
      v-if="props.level === ModalLevel.SUCCESS"
    ...
    <div
      v-if="props.level === ModalLevel.WARNING"
...
const props = defineProps<{ level: ModalLevel | null }>()
</script>
<script lang="ts">
export default {
  name: 'AmModalSvg',
